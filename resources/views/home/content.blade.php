...
<div class="bg0 m-t-23 p-b-140 m-t-80">
    <div class="container">
        <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
            ...
            <a href="{{ route('cate-home', ['id'=>$product->category->id, 'slug'=>Str::slug($product->category->category_name)]) }}" class="stext-109 cl8 hov-cl1 trans-04">
                    ...
                    <div class="p-l-25 p-r-30 p-lr-0-lg">
                        <div class="wrap-slick3 flex-sb flex-w">
                            ...
                            <div class="slick3 gallery-lb slick-initialized slick-slider slick-dotted">
                                ...
                                <div class="item-slick3 slick-slide" data-thumb="images/product-detail-02.jpg" data-slick-index="1" aria-hidden="true" style="width: 513px; position: relative; left: -513px; top: 0px; z-index: 998; opacity: 0;" tabindex="-1" role="tabpanel" id="slick-slide11" aria-describedby="slick-slide-control11">
                                    <div class="wrap-pic-w pos-relative">
                                ...
                                <div class="item-slick3 slick-slide" data-thumb="images/product-detail-03.jpg" data-slick-index="2" aria-hidden="true" style="width: 513px; position: relative; left: -1026px; top: 0px; z-index: 998; opacity: 0;" tabindex="-1" role="tabpanel" id="slick-slide12" aria-describedby="slick-slide-control12">
                                    <div class="wrap-pic-w pos-relative">
